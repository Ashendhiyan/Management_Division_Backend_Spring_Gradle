...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds, JpaVendorAdapter jpa){
        ...
        bean.setPackagesToScan("com.ipsoft.managementdivisionbackendgradle.entity");
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost/ManagementDivisionBackendGradleDatabase?createDatabaseIfNotExist=true");
        ds.setUsername("root");
        ds.setPassword("1234");
        return ds;
    }
